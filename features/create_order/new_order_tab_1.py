...
def new_order_tab(venue_id: int, role: str | None = None) -> None:
    ...
    # =========================================================
    # HEADER (notes mindset) + Active draft display  (FLOAT)
    # =========================================================
    ...
    TOP_UNDER_TOPBAR = "7.25rem"  # tweak to 3.5rem if your theme topbar is taller
